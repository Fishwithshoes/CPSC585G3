...
enum Maps
{
	...
	MAP_TRACK_ROUGHNESS,
	MAP_TRACK_NORMAL,
	MAP_CHASSIS_DIFFUSE_RED,//Sarge
	MAP_CHASSIS_DIFFUSE_ORANGE,//Grif
	MAP_CHASSIS_DIFFUSE_MAROON,//Simmons
	MAP_CHASSIS_DIFFUSE_PINK,//Donut
	MAP_CHASSIS_DIFFUSE_STEEL,//Church
	MAP_CHASSIS_DIFFUSE_TEAL,//Tucker
	MAP_CHASSIS_DIFFUSE_BLUE,//Caboose
	MAP_CHASSIS_DIFFUSE_BLACK,//Tex
